	...
	jRange.prototype = {
      ...
      onbarclicked: function() {},
		...
		setValue: function(value) {
		    ...
		    //console.log("this.options.from: ", this.options.from);
		...
		updateRange: function(range, value) {
		    ...
		    //FIX the improper positioning of the pointer when using setValue after a updateRange 
		    //due to the range keeping the previous "from" and "to" values [04-08-2018/Dan]
